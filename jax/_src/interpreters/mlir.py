...
class AttributeHandler(Protocol):
  def __call__(self, val: Any) -> ir.Attribute:
    ...
...
register_attribute_handler(str, ir.StringAttr.get)  # type: ignore
register_attribute_handler(bytes, ir.StringAttr.get)  # type: ignore
